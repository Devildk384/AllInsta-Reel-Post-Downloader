...
class GenrateVideoFrompath extends StatefulWidget {
  ...
  // final bool isreward;
  const GenrateVideoFrompath(this.path, this.isHome,this.updateVideoState, {super.key});
  @override
...
//   );
  ...
  Widget build(BuildContext context) {
    if (uint8list == null) {
      return Container(
          color: Colors.transparent, child: CupertinoActivityIndicator(color: Color.fromARGB(255, 238, 212, 13),));
    }
